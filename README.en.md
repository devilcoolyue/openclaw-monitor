...
- **Realtime log streaming**
  ...
  ![Realtime log streaming](image/screenshots/realtime_log.jpg)

- **Session detail view**

  ![Session detail view](image/screenshots/realtime_session.jpg)

- **Session stream playback**

  ![Session stream playback](image/gifs/realtime_session_stream.gif)

- **System dashboard**

  ![System dashboard](image/screenshots/system.jpg)

- **Gateway outline notification**

  ![Gateway outline notification](image/screenshots/gateway_outline_notify.jpg)
