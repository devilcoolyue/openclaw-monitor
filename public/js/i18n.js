...
export const I18N = {
  en: {
    ...
    modelSwitchSub: 'switch default model and restart gateway',
    modelLoading: 'Loading model config…',
    modelLoadFailed: 'Failed to load model config',
    modelConfigPath: 'Config file',
    modelCurrent: 'Current Model',
    modelCurrentHint: 'Current default model in openclaw config.',
    modelSelectTarget: 'Switch Target',
    modelAvailable: 'Available Models',
    modelSwitchBtn: 'Switch Model',
    modelSwitchHint: 'Switch will update openclaw.json and restart gateway.',
    modelSwitchProgressTitle: 'Switch Progress',
    modelSwitchStepWrite: 'Write config',
    modelSwitchStepRestart: 'Restart service',
    modelSwitchStepPending: 'Pending',
    modelSwitchStepRunning: 'Running…',
    modelSwitchStepDone: 'Done',
    modelSwitchStepFailed: 'Failed',
    modelAllOptions: 'All Model Options',
    modelNoOptions: 'No model options found',
    modelSwitching: 'Switching model…',
    modelSwitchDone: 'Model switched successfully',
    modelAlreadyCurrent: 'Already using selected model',
    modelSwitchFailed: 'Model switch failed',
    modelGatewayRestarted: 'Gateway restarted',
    modelSwitchSelectFirst: 'Please select a target model',
    modelApiInvalidJson: 'Model API returned invalid JSON',
    modelApiHtmlHint: 'Model API returned HTML. Please restart monitor service and re-login.',
    sysRefresh: 'Refresh',
  ...
  zh: {
    ...
    system: '系统',
    modelSwitch: '模型切换',
    modelSwitchSub: '切换默认大模型并重启 gateway',
    modelLoading: '正在加载模型配置…',
    modelLoadFailed: '加载模型配置失败',
    modelConfigPath: '配置文件',
    modelCurrent: '当前模型',
    modelCurrentHint: '当前 openclaw 默认模型配置。',
    modelSelectTarget: '切换目标',
    modelAvailable: '可选模型',
    modelSwitchBtn: '切换模型',
    modelSwitchHint: '点击切换后会更新 openclaw.json 并重启 gateway。',
    modelSwitchProgressTitle: '切换进度',
    modelSwitchStepWrite: '写入配置',
    modelSwitchStepRestart: '重启服务',
    modelSwitchStepPending: '等待中',
    modelSwitchStepRunning: '执行中…',
    modelSwitchStepDone: '已完成',
    modelSwitchStepFailed: '失败',
    modelAllOptions: '全部模型选项',
    modelNoOptions: '未发现可选模型',
    modelSwitching: '正在切换模型…',
    modelSwitchDone: '模型切换成功',
    modelAlreadyCurrent: '当前已是所选模型',
    modelSwitchFailed: '模型切换失败',
    modelGatewayRestarted: 'Gateway 已重启',
    modelSwitchSelectFirst: '请先选择目标模型',
    modelApiInvalidJson: '模型接口返回了无效JSON',
    modelApiHtmlHint: '模型接口返回了HTML，请重启 monitor 服务并重新登录。',
    sysRefresh: '刷新',
    sysLastUpdate: '上次更新',
